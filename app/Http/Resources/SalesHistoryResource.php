...
class SalesHistoryResource extends JsonResource
{
    ...
    public function toArray($request)
    {
        return [
            ...
            'numDocumento' => $this->json_enviado['receptor']['numDocumento'] ?? $this->json_enviado['receptor']['nit'] ?? null,
            'tipoDocumento' => $this->json_enviado['receptor']['tipoDocumento'] ?? null,
            'correo' => $this->json_enviado['receptor']['correo'] ?? null,
            'telefono' => $this->json_enviado['receptor']['telefono'] ?? null,

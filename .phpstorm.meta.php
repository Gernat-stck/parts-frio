...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'filesystems.links.C:\Users\nager\OneDrive\Escritorio\PartsFrioProyecto\parts-frio\public\storage' => 'string',
            ...
            'roles.dashboards.admin' => 'string',
            'roles.dashboards.employee' => 'string',
            'roles.dashboards.customer' => 'string',
            'roles.dashboards.supplier' => 'string',
            'roles.dashboards.manager' => 'string',
            'roles.dashboards.accountant' => 'string',
            'roles.dashboards.salesperson' => 'string',
            'roles.default_route' => 'string',
            'roles.available_roles' => 'array',
...
'filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\nager\\OneDrive\\Escritorio\\PartsFrioProyecto\\parts-frio\\public\\storage','inertia.ssr.enabled','inertia.ssr.url',
...
'queue.failed.database','queue.failed.table','roles.dashboards.admin','roles.dashboards.employee','roles.dashboards.customer',
'roles.dashboards.supplier','roles.dashboards.manager','roles.dashboards.accountant','roles.dashboards.salesperson','roles.default_route',
'roles.available_roles','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
...
'admin.dashboard','admin.inventory','admin.inventory.create','admin.inventory.edit','admin.users',
'admin.sales','admin.sales.receiver','admin.sales.payment','admin.sales.invoice','admin.sales.history',
'admin.sales.record','employee.dashboard','employee.dashboard','employee.inventory','storage.local',);
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','HACIENDA_API_URL',
'HACIENDA_API_USER','HACIENDA_API_PASSWORD','HACIENDA_ENVIRONMENT',);
